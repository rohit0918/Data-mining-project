...
def run_fpgrowth(transactions, all_items, min_support, min_confidence):
    """
...
if __name__ == "__main__":
    # Example usage
    print("\n" + "="*80)
    print("FP-GROWTH ALGORITHM - STANDALONE EXECUTION")
    print("="*80)
    ...
    # Run algorithm
    frequent_itemsets_df, rules_df, exec_time = run_fpgrowth(
    ...
    print("\n" + "="*80)
    print("✅ FP-GROWTH ANALYSIS COMPLETE!")
    print("="*80)
